...
YELLOW_SPACE = pygame.image.load("spaceship_yellow.png")
YELLOW_SPACE = pygame.transform.rotate(pygame.transform.scale(YELLOW_SPACE, (SW, SH)), 90)
RED_SPACE = pygame.image.load("spaceship_red.png")
RED_SPACE = pygame.transform.rotate(pygame.transform.scale(RED_SPACE, (SW, SH)), 270)
...
def main():
    red = pygame.Rect(1650, 450, SW, SH)
    yellow = pygame.Rect(150, 450, SW, SH)
